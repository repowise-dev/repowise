...
| Flag | Description |
|------|-------------|
| `--provider` | LLM provider: `anthropic`, `openai`, `openrouter`, `edenai`, `gemini`, `deepseek`, `kimi`, `ollama`, `litellm`, `codex_cli`, `opencode`, `mock` |
| `--model` | Model name override (e.g., `claude-sonnet-4-6`) |
| `--embedder` | Embedder for semantic search: `gemini`, `openai`, `openrouter`, `edenai`, `ollama`, `mock` (default: auto-detect) |
...
| Flag | Description |
|------|-------------|
| `--embedder` | `gemini`, `openai`, `openrouter`, `edenai`, `ollama`, `mock`, or `auto` (default: auto) |
