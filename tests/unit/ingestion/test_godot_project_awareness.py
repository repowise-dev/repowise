"""Unit tests for Phase 3 — Godot project awareness.

Three mechanisms, none of which needs the ``tree_sitter_gdscript`` grammar
...
3. ``framework_edges/godot.py`` — ``class_name`` global-registry edges.
...
# ---------------------------------------------------------------------------
# 3. class_name global-registry edges
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 4. Godot engine callbacks are not dead code
# ---------------------------------------------------------------------------
