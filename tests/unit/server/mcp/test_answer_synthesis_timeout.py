...
@pytest.mark.parametrize("name", ["codex_cli", "claude_cli", "opencode", "omp"])
...
def test_agent_cli_budget_stays_under_its_own_subprocess_ceiling():
    ...
    from repowise.core.providers.llm import claude_cli, codex_cli, omp, opencode
    ...
    assert omp.OmpProvider.interactive_timeout_s < omp._EXEC_TIMEOUT_SECONDS
