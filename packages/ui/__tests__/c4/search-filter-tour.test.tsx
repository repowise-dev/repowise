...
const mockView: ArchitectureView = {
  ...
  nodes: [
    ...
    { id: "src/models.py", node_type: "file", name: "models.py", file_path: "src/models.py", line_range: null, summary: "Data models for database", complexity: "complex", tags: ["python", "core"], language: "python", pagerank: 0.8, pagerank_percentile: 95, betweenness: 0.5, in_degree: 5, out_degree: 1, community_id: 2, is_entry_point: false, is_test: false, is_hotspot: false, is_dead: false, has_doc: true, primary_owner: "dev1", primary_owner_pct: 0.9, bus_factor: 1 },
  ],
  edges: [
  ...
  tour: [
    { order: 1, title: "Entry Point", description: "Start here with the main app", node_ids: ["src/app.py"] },
    { order: 2, title: "Routes", description: "HTTP request handlers", node_ids: ["src/routes.py"] },
    { order: 3, title: "Models", description: "Data layer and ORM", node_ids: ["src/models.py"] },
  ],
  total_files: 3,
  total_symbols: 25,
  total_edges: 3,
