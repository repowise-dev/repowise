...
import { ChatMarkdown } from "../../src/chat/chat-markdown.js";
...
describe("ChatMarkdown", () => {
  it("renders reply body at the reading scale, not chrome sizes", () => {
    ...
    render(<ChatMarkdown content="A plain paragraph." />);
  ...
  it("never renders inline code in the accent", () => {
    ...
    const { container } = render(
      <ChatMarkdown content="Look at `src/auth/session.py` for this." />,
    );
