...
function resolveInkPalette() {
  return {
    ...
    ink: resolveToken("--color-diagram-node-fill", "#241b2c"),
    ink2: resolveToken("--color-diagram-node-fill-2", "#4a4152"),
    inkText: resolveToken("--color-diagram-node-text", "#fbf6f1"),
    inkBorder: resolveToken("--color-diagram-node-border", "#241b2c"),
