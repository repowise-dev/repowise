...
const PROVIDERS = ["gemini", "openai", "anthropic", "deepseek", "kimi", "minimax", "opencode", "ollama", "litellm", "mock"] as const;
...
const PROVIDER_ENV_VARS: Record<string, { vars: string[]; installHint: string }> = {
  ...
  minimax: { vars: ["MINIMAX_API_KEY", "MINIMAX_BASE_URL"], installHint: "pip install openai" },
