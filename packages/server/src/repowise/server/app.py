        ...
        if ws_root is not None:
            ...
            if configured_db_url is not None:
                ...
                for repo_entry in ws_config.repos:
                    ...
                    # server's lifetime (workspace_engines/workspace_sessions), matching
                    # the long-lived pattern in the two engines above. If this URL is
                    # ever made configurable (e.g. pointed at a shared REPOWISE_DB_URL
                    # for workspace members), it must pass short_lived=False too.
