...
_TYPE_INSTRUCTIONS: dict[str, str] = {
    ...
    "extract_method": (
        ...
        "slice's output value when it has exactly one and otherwise from the "
        "enclosing function, so keep it unless the code clearly warrants a better "
        "name -- and rename it if it collides with something already in the file, "
        "which it can. Pass the plan's 'params' as its arguments "
